...
namespace vr
{
	...
	static const char * const IVROverlayView_Version = "IVROverlayView_002";
...
namespace vr
{
	...
	public:
		...
		virtual bool UknFunc003(void* pInternalObject, uintptr_t* reserved) = 0;
		/**
         * Slot 4 (0x18)
         * @param nHandle (RSI) - Das Eingabe-Handle
         * @param pOutInternalHandle (RDX) - Ausgabeparameter für ein internes Handle
         * @return Status-Code (0 für Erfolg)
         */
        virtual uint32_t UknFunc004(uintptr_t nHandle, uintptr_t* pOutInternalHandle) = 0;
